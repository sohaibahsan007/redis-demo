...
Next, implement a cache strategy provider. It can contain any custom cache set and get logic.
One use case is to instead of storing a list of products as one key, you can create separate keys against each product id.
